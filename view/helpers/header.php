        ...
        <header>
            ...
            <?php
                ...
                if($url_actual == $paginaconsulta){
                    ...
                    echo '<a href="view/helpers/tablasdebd_page.php">Consultar DB </a>';
                }
                ...
                if($url_actual == $pgardarenbd){
                    ...
                    echo '<a href="view/helpers/guardaenbd_page.php">Subir datos</a>';
                }
                ...
                if($url_actual == $pacerdade){
                    echo '<a href="acerdade_page.php">Acerca de </a>';
                }else{
                    echo '<a href="view/helpers/acerdade_page.php">Acerca de </a>';
                }
            ?>
        </header>
    </div>